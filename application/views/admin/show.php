...
<div class="content-box">
  ...
  <div class="content-box-content">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <!-- Icons -->
              <a href="<?php echo site_url('admin/admin/deleteAdmin' , array('id' => $v['id']));?>" title="Delete"><img src="<?php echo $this->config->item("img_path"); ?>icons/cross.png" alt="Delete" /></a>
    ...
    <div class="tab-content" id="tab2">
      <form role="form" id="local_form" method="post" enctype="multipart/form-data" action="<?php echo site_url('admin/admin/doAddAdmin')?>">
        <fieldset>
