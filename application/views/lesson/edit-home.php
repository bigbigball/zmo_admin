            	...
            	<form role="form" id="local_form" method="post" enctype="multipart/form-data" action="<?php echo site_url('teacher/teacher/doAddHomeTeacher')?>">
                  <div class="form-group">
                    ...
                    <select class="form-control input-lg" name="id" id="id">
                        ...
                        <option value="<?php echo $v['id'] ;?>" <?php if(!empty($cinfo) && $cinfo['id'] == $v['id']){ echo 'selected="selected"';}?>>---<?php echo $v['name'];?> ---</option>
						<?php }}?>
                    </select>
                  </div>
                  <?php if(!empty($cinfo['home_img'])){?>
                  <div class="form-group">
                    <label for="exampleInputFile">首页热门导师展示图片</label>
                   	<img src="<?php echo $cinfo['../teacher - 拷贝/home_img'] ;?>"/>
                  </div>
                  <?php }?>
                  <div class="form-group">
                    <label for="exampleInputFile">首页热门导师展示图片</label>
                  ...
                  <!--div class="form-group">
                    <label for="exampleInputFile">取消该首页热门导师展示图片</label>
