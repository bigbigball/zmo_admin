  ...
  <div class="content-box-content">
    ...
    <div class="tab-content" id="tab2">
      <form role="form" id="local_form" method="post" enctype="multipart/form-data" action="<?php echo site_url('active/active/doAddActive')?>">
        ...
        <p>
          <label>活动主题</label>
          <input class="text-input small-input" type="text" id="theme" placeholder="例如：世界经济论坛" name="theme"/>
        </p>
        <p>
          <label>时间期限</label>
         ...
         <p>
          <label>报名人数</label>
          <input class="text-input small-input" type="text" id="amount" placeholder="10[0为不限制]" name="amount"/>
        </p>
        <p>
        ...
        <p>
          <label>缴费金额</label>
          <input class="text-input small-input" type="text" id="price" placeholder="0" name="price"/>
        </p>
        <p>
          <label>列表页描述</label>
